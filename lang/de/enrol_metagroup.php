...
$string['pluginname_desc'] = 'Das Plugin Meta-Einschreibung synchronisiert die Einschreibungen und Rollen in aus einer Gruppe des Quell-Kurses in einen Ziel-Kurs.';
$string['syncall'] = 'Eingeschriebene Nutzer/innen synchronisieren';
$string['syncall_desc'] = 'Wenn diese Option aktiviert ist, werden alle Nutzer/innen synchronisiert, auch wenn sie in der ausgewählten Gruppe des Hauptkurs keine Rolle haben. Wenn diese Option deaktiviert ist, werden nur Nutzer/innen in Metakurse synchronisiert, die in der ausgewählten Gruppe des Hauptkurses mindestens eine Rolle besitzen.';